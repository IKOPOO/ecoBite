...
import { LeafIcon, RecycleIcon, ShoppingBagIcon, StoreIcon, ChevronRightIcon } from "@/components/shared/icons"
...
export function LandingHero() {
  ...
  return (
    <section className="relative overflow-hidden py-20 lg:py-32">
      {/* Decorative linears with Parallax */}
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div
          className="absolute -left-[10%] -top-[10%] h-125 w-125 rounded-full bg-primary/20 blur-[100px] opacity-40 dark:opacity-20 transition-transform duration-75 ease-out"
          style={{ transform: `translateY(${scrollY * 0.2}px)` }}
        />
        <div
          className="absolute -right-[10%] bottom-[10%] h-125 w-125 rounded-full bg-green-400/20 blur-[100px] opacity-40 dark:opacity-20 transition-transform duration-75 ease-out"
        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          <div className="space-y-8 animate-in fade-in slide-in-from-left-10 duration-700 fill-mode-forwards">
            ...
            <h1 className="text-balance text-5xl font-extrabold tracking-tight lg:text-7xl leading-[1.1]">
              Makan Enak, <br />
              <span className="bg-linear-to-r from-primary via-green-500 to-emerald-600 bg-clip-text text-transparent">
                Tanpa Sisa.
              </span>
            </h1>

            <p className="max-w-lg text-xl text-muted-foreground leading-relaxed">
              Temukan makanan berkualitas dari restoran favoritmu dengan harga hemat hingga 70%. Pilihan cerdas untuk
              dompet dan bumi.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              ...
              <Link href="/register?role=seller">
                <Button
                  size="lg"
                  variant="outline"
                  className="h-14 gap-2 rounded-full border-2 px-8 text-base hover:bg-muted/50"
                >
          ...
          <div
            className="relative isolate animate-in fade-in slide-in-from-right-10 duration-1000 delay-200 fill-mode-forwards"
            style={{ transform: `translateY(${scrollY * 0.05}px)` }}
          >
            <div className="relative mx-auto aspect-4/5 w-full max-w-125 overflow-hidden rounded-[2.5rem] shadow-2xl ring-1 ring-border/20">
              <img
